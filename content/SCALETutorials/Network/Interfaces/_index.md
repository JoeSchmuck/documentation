...
You can change this to a static, or fixed IP address [using the Console Setup menu](/scale/gettingstarted/install/consolesetupmenuscale/) before accessing the web UI or after logging into the UI from the **Network** screen.
